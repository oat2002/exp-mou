        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    ...
                    <input type="password" onkeyup="chkPassword()" name="pass" class="form-control" required>
                </div>
                <div class="col-3">
                    <label>ยืนยันรหัสผ่าน</label>
                    <input type="password" id="rePass" onkeyup="chkPassword()" class="form-control" required>
